    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: const TextStyle(color: AppColors.greyDark, fontWeight: FontWeight.w400),
          prefixIcon: const Icon(Icons.search, color: AppColors.greyDark, size: 22),
          suffixIcon: _searchQuery.isNotEmpty 
            ? IconButton(
                icon: const Icon(Icons.clear, color: AppColors.greyDark, size: 20),
                onPressed: () {
