...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final HomeUiProvider _uiProvider = HomeUiProvider();
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<HomeUiProvider>.value(
      value: _uiProvider,
      child: Consumer<HomeUiProvider>(
        builder: (context, uiState, _) => Scaffold(
                          ...
                          child: Column(
                            ...
                            children: [
                              Icon(
                                ...
                                size: 64,
                                color: AppColors.greyMedium.withValues(
                                  alpha: 0.5,
                                ),
                              ),
  ...
  Widget _buildSearchField(HomeUiProvider uiState) {
    return Padding(
